...
import ir.ac.fum.enrollment.profile.security.UserDetailsImpl;
...
public class TokenService {
    ...
    public String generateRegisterToken(StudentEntity user) {
        return generateToken(new UserDetailsImpl(user), Duration.ofHours(1));
    }

    public String generateVerifyToken(StudentEntity user) {
